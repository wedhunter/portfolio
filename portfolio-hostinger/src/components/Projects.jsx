  ...
  return (
    <div id="projects" className="max-w-[1040px] m-auto md:pl-20 p-4 py-16">
      ...
      <p className="text-center py-8">
        ...
        quibusdam exercitationem voluptatibus est illum necessitatibus,
        similique eum architecto fuga deleniti? Omnis cum labore deleniti
        molestias, eius explicabo consectetur veniam.
      </p>
